...
class Actor(nn.Module):
    def __init__(self, state_size=33, action_size=4, seed=42, fc1_units=512, fc2_units=256, fc3_units=128):
...
class Critic(nn.Module):
    def __init__(self, state_size=33, action_size=4, seed=42, fcs1_units=384, fca1_units=128, fc2_units=256, fc3_units=128):
